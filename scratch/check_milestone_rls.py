...
# Check if there are rows in student_milestone_progress
print("=" * 70)
print("Student Milestone Progress rows:")
print("=" * 70)
print(json.dumps(get_data("student_milestone_progress", "select=student_id,cumulative_xp,coins,gems"), indent=2))
