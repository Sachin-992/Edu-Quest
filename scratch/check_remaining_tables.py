...
tables = [
    "feedback", "feedback_audit_log", "push_subscriptions", "notification_preferences",
    "user_identity_secrets", "password_audit_log", "subject_teacher_assignments"
]

print("=" * 60)
print("REMAINING TABLES CHECK")
print("=" * 60)
for t in tables:
