...
async function applyUnitSchema() {
    console.log('🔧 Applying academic_files unit schema migration...');

    const sqlPath = path.join(__dirname, '../sql/104_add_unit_to_academic_files.sql');
    ...
    if (error) {
        ...
        console.log("👉 Please copy the content of '104_add_unit_to_academic_files.sql' and run it in the Supabase SQL Editor.");
        process.exit(1);
    }

    console.log('✅ academic_files unit schema applied successfully!');
}
