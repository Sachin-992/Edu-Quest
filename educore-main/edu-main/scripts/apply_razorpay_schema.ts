...
async function applyRazorpaySchema() {
    console.log('🔧 Applying Razorpay fee collection schema...');

    const sqlPath = path.join(__dirname, '../sql/103_razorpay_fee_collection.sql');
    ...
    if (error) {
        ...
        console.log("👉 Please copy the content of '103_razorpay_fee_collection.sql' and run it in the Supabase SQL Editor.");
        process.exit(1);
    }

    console.log('✅ Razorpay fee collection schema applied successfully!');
}
