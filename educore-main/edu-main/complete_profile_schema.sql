-- ═══════════════════════════════════════════════════════════════════════════════
-- EDUCORE-OMEGA COMPLETE PROFILE SCHEMA
-- Extended Student & Teacher Profiles with Aadhaar Security
...
-- DROP TABLE IF EXISTS aadhaar_access_logs CASCADE;
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- STEP 3: USERS TABLE (Core Identity)
-- ═══════════════════════════════════════════════════════════════════════════════
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- STEP 4: EXTENDED STUDENTS TABLE
-- ═══════════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS students (
    ...
    -- GOVERNMENT ID (ENCRYPTED - ADMIN ONLY)
...
-- ═══════════════════════════════════════════════════════════════════════════════
-- STEP 5: EXTENDED TEACHERS TABLE
-- ═══════════════════════════════════════════════════════════════════════════════
...
CREATE TABLE IF NOT EXISTS teachers (
    ...
    employment_status TEXT DEFAULT 'active' CHECK (employment_status IN ('active', 'inactive', 'resigned', 'retired')),
...
CREATE INDEX IF NOT EXISTS idx_aadhaar_logs_actor ON aadhaar_access_logs(actor_id);
CREATE INDEX IF NOT EXISTS idx_aadhaar_logs_entity ON aadhaar_access_logs(entity_type, entity_id);

-- ═══════════════════════════════════════════════════════════════════════════════
-- STEP 15: AUDIT LOG IMMUTABILITY
-- ═══════════════════════════════════════════════════════════════════════════════
...
CREATE POLICY "files_owner" ON files FOR ALL USING (
...
-- Sample Students
INSERT INTO students (name, class, section, roll_no, admission_number, gender, fee_status, status)
VALUES 
...
-- Sample Teachers
INSERT INTO teachers (name, email, subject, employee_id, designation, qualification, experience_years)
VALUES 
